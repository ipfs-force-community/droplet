...
func NewManager(ctx metrics.MetricsCtx, ds models.PayChanDS, messager clients.IMessager, walletClient clients.ISinger, fullNode apiface.FullNode) (*paychmgr.Manager, error) {
