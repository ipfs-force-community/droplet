...
// BadgerBlockstore is a badger-backed IPLD blockstore.
//
...
func (b *BadgerBlockstore) Compact() error {
	if atomic.LoadInt64(&b.state) != stateOpen {
		return ErrBlockstoreClosed
	}
...
// Has implements BadgerBlockstore.Has.
...
// Get implements BadgerBlockstore.Get.
...
// GetSize implements BadgerBlockstore.GetSize.
...
// Put implements BadgerBlockstore.Put.
...
// PutMany implements BadgerBlockstore.PutMany.
...
// DeleteBlock implements BadgerBlockstore.DeleteBlock.
...
// AllKeysChan implements BadgerBlockstore.AllKeysChan.
...
// HashOnRead implements BadgerBlockstore.HashOnRead. It is not supported by this
// blockstore.
