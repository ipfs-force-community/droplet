...
type CurrentDealInfoAPI interface {
	...
	StateLookupID(context.Context, address.Address, markettype.TipSetToken) (address.Address, error)
	StateMarketStorageDeal(context.Context, abi.DealID, markettype.TipSetToken) (*chain.MarketDeal, error)
...
type CurrentDealInfo struct {
	...
	PublishMsgTipSet markettype.TipSetToken
}
...
func (mgr *CurrentDealInfoManager) GetCurrentDealInfo(ctx context.Context, tok markettype.TipSetToken, proposal *market.DealProposal, publishCid cid.Cid) (CurrentDealInfo, error) {
...
func (mgr *CurrentDealInfoManager) dealIDFromPublishDealsMsg(ctx context.Context, tok markettype.TipSetToken, proposal *market.DealProposal, publishCid cid.Cid) (abi.DealID, markettype.TipSetToken, error) {
	dealID := abi.DealID(0)
	...
	if proposal == nil {
		...
		return retval.IDs[0], lookup.TipSet.Bytes(), nil
	}
	...
	return retval.IDs[dealIdx], lookup.TipSet.Bytes(), nil
}

func (mgr *CurrentDealInfoManager) CheckDealEquality(ctx context.Context, tok markettype.TipSetToken, p1, p2 market.DealProposal) (bool, error) {
...
func (c *CurrentDealInfoAPIAdapter) StateLookupID(ctx context.Context, a address.Address, tok markettype.TipSetToken) (address.Address, error) {
...
func (c *CurrentDealInfoAPIAdapter) StateMarketStorageDeal(ctx context.Context, dealID abi.DealID, tok markettype.TipSetToken) (*chain.MarketDeal, error) {
	tsk, err := types.TipSetKeyFromBytes(tok)
	if err != nil {
...
func (c *CurrentDealInfoAPIAdapter) StateSearchMsg(ctx context.Context, k cid.Cid) (*chain.MsgLookup, error) {
